					...
					>
						...
						<div className='help-container' style={{ padding: '5.7rem 17rem 1rem' }}>
							...
							<ul>
								...
								<li>CMD/CTRL+L - activate in-page search</li>
							...
							<h2>What is Yarnpoint?</h2>
							<p>
								Yarnpoint is a way of being & thinking. Yarnpoint allows you to create, explore, and
								share networks made out of content! You can use Yarnpoint for whatever you want,
								some ideas include "building a mind palace, storing URL bookmarks, exploring your
								...
								overwhelming but it's really not so bad once you get familiar. Yarnpoint tries its
							...
							<p>
								Yarnpoint is premised on the idea that all content is a <i>node</i> which can be
								...
								two ideas, you understand Yarnpoint! That's all there is to it, the rest is just
							...
							<p>
								...
								to manage additional Yarnpoint tabs.
							</p>
							...
							<p>
								...
								image from the internet or from elsewhere in Yarnpoint (right click and "copy image
							...
							<p>
								...
								folder! This is really handy because it means Yarnpoint can be used to create
							...
							<p>
								...
								<i>.synth</i> files, which can be re-imported by anyone into any Yarnpoint instance
								on any computer. These files are represented within Yarnpoint by this{' '}
							...
							<p>
								If you have created or imported a Yarnpoint export into your Yarnpoint instance, you
							...
							<h2>How do files work starting in Yarnpoint 1.2.3?</h2>
							<p>
								Starting with version 1.2.3, it is possible to link files in your filesystem to
								Yarnpoint by creating file nodes. File nodes existed before, but they didn't do
								much. Starting with version 1.2.3, it is possible to open certain file types
								(photoshop projects, .txt files, word documents, images, .mp3s, .pdfs, 3D models,
								and so forth) in their default program directly from Yarnpoint! The way this works
								is pretty straightforward...Once you create a file node you can either right click
								the node card to launch the file, or click through to the landing page to launch.
							</p>
							<p>
								When you delete a file node, it will not delete the file itself, only the node in
								Yarnpoint. You should know however, that if you imported a node into Yarnpoint from
								a .synth export and delete the node, it WILL delete the file...Why this difference?
								The idea is basically that Yarnpoint cleans up after itself. If it creates a file,
								it will delete it, but if YOU created the file, Yarnpoint will not delete it.
							</p>
							<p>
								In other words, Yarnpoint will not mess with your stuff! If you want to keep
								imported files long-term it is recommended that you copy them out of the
								import-location into a better place!
							</p>
							<h2>Context Actions starting in Yarnpoint 1.2.3</h2>
							<p>
							...
							<p>
								Yarnpoint is an open-source project and is licensed under GPLv3 which means if you
							...
							<p>
								...
								Yarnpoint (other colors than yellow for example), and more, but you should know that
								...
								about it or reach out to the Yarnpoint email account, and I could maybe bump it up
								as a priority! User feedback does play a role in what I decide to work on.
							</p>
